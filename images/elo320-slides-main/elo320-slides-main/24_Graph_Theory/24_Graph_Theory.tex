...
Es un TDA que modela un \textit{conjunto de objetos}, que pueden estar conectados entre si mediante \textit{enlaces}. 

\begin{center}
\includegraphics[width=0.3\linewidth]{images/graphs/graph-undirected}
\end{center}

Los grafos son fácilmente visualizables, en donde los objetos son representados por nodos, llamados \textbf{vértices}, y están interconectados por enlaces, denominados \textbf{aritstas}.
\end{frame}
...
\begin{center}
\includegraphics[width=0.24\linewidth]{images/graphs/graph-undirected}
\end{center}
\item Grafo Dirigido: Enlaces con una dirección específica.
\begin{center}
\includegraphics[width=0.24\linewidth]{images/graphs/graph-directed}
\end{center}
\end{itemize}
\end{frame}
...
\begin{center}
\includegraphics[width=0.26\linewidth]{images/graphs/graph-adjacent}
\end{center}
\item Vecindario: Todos los nodos adyacentes respecto a un vértice.
\begin{center}
\includegraphics[width=0.26\linewidth]{images/graphs/graph-neighbourhood}
\end{center}
\end{itemize}
\end{frame}
...
\begin{center}
\includegraphics[width=0.23\linewidth]{images/graphs/graph-chain}
\end{center}
...
\begin{center}
\includegraphics[width=0.23\linewidth]{images/graphs/graph-path}
\end{center}
\end{itemize}
\end{frame}
...
\begin{center}
\includegraphics[width=0.23\linewidth]{images/graphs/graph-cycle}
\end{center}
\item Árbol de Expansión: Cadena de $(n-1)$ arcos que conecta toda la red y no contiene ciclos.
\begin{center}
\includegraphics[width=0.23\linewidth]{images/graphs/graph-spanning-tree}
\end{center}
\end{itemize}
\end{frame}
...
\item Grafo Dirigido:
\begin{center}
\includegraphics[width=0.65\linewidth]{images/graphs/graph-adjacent-list-directed}
\end{center}
\item Memoria: $\Theta(|\mathcal{V}|+|\mathcal{A}|)$.
\item Añadir Vértice: $\mathcal{O}(1)$.
\item Añadir Arista: $\mathcal{O}(1)$.
...
\begin{center}
\includegraphics[width=0.60\linewidth]{images/graphs/graph-adjacent-matrix-directed}
\end{center}
...
\item Utiliza una pila como TDA auxiliar. 
...
\begin{center}
\includegraphics[width=0.7\linewidth]{images/dfs1}
\end{center}
\end{frame}
...
\begin{frame}[fragile]
 \frametitle{DFS: Ordenamiento Topológico}\small
\begin{center}
\includegraphics[width=\linewidth]{images/graphs/graph-topsort-2}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.7\linewidth]{images/graphs/pancakes}
\end{center}
\end{itemize}
\end{frame}
