...
\small
\begin{center}
\includegraphics[width=0.8\linewidth]{images/heapsort/heap}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.65\linewidth]{images/heapsort/max-heap1}
\end{center}

\begin{center}
\includegraphics[width=0.65\linewidth]{images/heapsort/max-heap2}
\end{center}
\end{frame}
