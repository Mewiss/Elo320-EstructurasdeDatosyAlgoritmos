...
\begin{center}
\includegraphics[width=.6\linewidth]{images/hash1}
\end{center}
\end{frame}
...
\begin{frame}[fragile]
 \frametitle{Tablas Hash}
\small
Diseñadas originalmente para resovler el \textbf{problema de búsqueda} $\rightarrow$ basada en arreglos, pero sin trabajar con el índice.  Algunos usos:
\begin{itemize}
...
\small
En este método las claves son transformadas en índices del arreglo mediante el uso de resto aritmético o módulo sobre el largo del arreglo:
