...
\small
TDA que permite operar solo en uno de sus extremos. Es de tipo \textbf{LIFO: Last In, First Out}. Puede ser implementada con arreglos o listas. 
...
Aplicaciones:
\begin{itemize}
\item Control+Z/Control+Y: Operaciones de Desahcer o Rehacer (undo/redo).
\item Compilación: Formulas matemáticas en notacion de primer orden, i.e. $(x\ 1\ (+\ 2\ 3)) = x\ 1\ +\ 2\ 3$
\item Busqueda en árboles: Búsqueda en Profundidad (DFS).
\end{itemize}
\end{frame}
...
\small
TDA que permite operar en un extremo para entrada y en otro extremo para salida. Simula el comportamiento de una fila o cola. Es de tipo \textbf{FIFO: First In, First Out}. Puede ser implementada con arreglos o listas. 
