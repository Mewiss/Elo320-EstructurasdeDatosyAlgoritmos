...
\title{ELO320 - Estructuras de Datos y Algoritmos\\Introducción a C\\TDA y Listas Enlazadas}
...
\begin{frame}[fragile]
 \frametitle{Modulo 1.1: Lista Simple Enlazada}
...
\begin{frame}[fragile]
\frametitle{Modulo 2.1: Lista Enlazada DLC 1}
...
Implemente una lista DLC 1, para algún tipo de dato a su elección, que incluya las funciones más conocidas de las listas de Python:
...
%}
%\part{Mejoras}
%\section{Mejora: Lista enlazada DLC 1}
%\begin{frame}[fragile]
%\frametitle{Lista Enlazada DLC 1}
%Existen otras implementaciones de listas enlazadas simples, donde se incluyen más punteros y variables de control.
%
%\begin{exampleblock}{C}
%\begin{lstlisting}[language=C, basicstyle=\tiny, escapeinside={|}{|}]
...
%\begin{frame}[fragile]
%\frametitle{Lista de Pythob eb C}
%
